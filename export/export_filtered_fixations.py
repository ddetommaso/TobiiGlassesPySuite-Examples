...
from tobiiglasses.filters.df import BetweenLoggedEvents
...
ft = BetweenLoggedEvents("start_recording", "stop_recording")
ff = FilterDT(dispersion_threshold=15, duration_threshold=150)
rec.exportCSV_Fixations(fixation_filter=ff, ts_filter=ft)
