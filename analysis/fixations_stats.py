...
fixations = rec.getFixations(fixation_filter=FilterDT(), aoi_model=GaussianMixture(n_clusters=2))
f_metrics = Fixations_Metrics(fixations)
"""
print(f_metrics.getAOIs_TTFF())
print(f_metrics.getAOIs_FirstFixationDuration())
print(f_metrics.getAOIs_TotalFixationDuration())
"""
print(f_metrics.getFixationsStats())
